...
func (l loggingMiddleware) RegisterNewUserForm(ctx context.Context) (e0 error) {
	defer func() {
		l.logger.Log("method", "RegisterNewUserForm", "e0", e0)
	}()
	return l.next.RegisterNewUserForm(ctx)
}
func (l loggingMiddleware) UserLoginForm(ctx context.Context) (e0 error) {
	defer func() {
		l.logger.Log("method", "UserLoginForm", "e0", e0)
	}()
	return l.next.UserLoginForm(ctx)
}
func (l loggingMiddleware) UserRegisterForm(ctx context.Context) (e0 error) {
	defer func() {
		l.logger.Log("method", "UserRegisterForm", "e0", e0)
	}()
